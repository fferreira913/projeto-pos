...
public class TesteTitulo {
    ...
    public static void pagarPromissoria() throws IOException{
        Promissoria promissoria = new Promissoria();
        ...
        ClientResource clientResource = new ClientResource("http://localhost:80/app/pagarPromissoria");
    ...
    public static void pagarDuplicada() throws IOException{
        Duplicada duplicada = new Duplicada();
        duplicada.setBanco(Banco.BB);
        duplicada.setDataEmissao("01/12/2015");
        duplicada.setDataPagamento("13/12/2015");
        ...
        ClientResource clientResource = new ClientResource("http://localhost:80/app/pagarDuplicada");
